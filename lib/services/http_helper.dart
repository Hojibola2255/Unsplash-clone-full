...
class HttpInterceptor implements InterceptorContract {
  static String CLIENT_ID = "vqx7lE919INOosIGUcKQa-gbeqU1NngChZxIFXlmXXM";
  ...
  Future<RequestData> interceptRequest({required RequestData data}) async {
    try {
      ...
      // access token vaqti kam boladi 1 kun aatrofida odatda (ixtiyoriy)

      // Fetching access token from your local
      var accessToken = "";
      // localdagi tokenni oqish kere
