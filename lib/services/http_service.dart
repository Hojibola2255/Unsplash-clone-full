...
sealed class Network {
  ...
  /// create post
  static Future<String?>create({required String api, required Map<String, dynamic> data})async{
    return "";
  }
  /// update == put
  static Future<String?>update({required String api,required String id, required Map<String, dynamic> data})async{
    return "";
  }
  static Future<String?>delete({required String api, required String id})async{
    return "";
  }
